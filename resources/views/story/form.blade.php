...
<div class="modal-dialog modal-simple">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="formModalLabel">{{ ($story->exists?'Edit':'Tambah').' storys' }}</h4>
  </div>
  <div class="modal-body">
    {!! App\Console\Commands\Generator\Form::input('id','hidden')->model($story)->showHidden() !!}
    {!! App\Console\Commands\Generator\Form::input('judul','text')->model($story)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('waktu','text')->model($story)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('story','text')->model($story)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('foto','text')->model($story)->show() !!}
