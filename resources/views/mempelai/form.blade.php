...
<div class="modal-dialog modal-simple">
  {{ Form::model($mempelai,array('route' => array((!$mempelai->exists) ? 'mempelai.store':'mempelai.update',$mempelai->pk()),
  'class'=>'modal-content','id'=>'mempelai-form','method'=>(!$mempelai->exists) ? 'POST' : 'PUT')) }}
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">×</span>
    </button>
    <h4 class="modal-title" id="formModalLabel">{{ ($mempelai->exists?'Edit':'Tambah').' mempelais' }}</h4>
  </div>
  <div class="modal-body">
    {!! App\Console\Commands\Generator\Form::input('id','hidden')->model($mempelai)->showHidden() !!}
    {!! App\Console\Commands\Generator\Form::input('nama','text')->model($mempelai)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('biodata','text')->model($mempelai)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('facebook','text')->model($mempelai)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('twitter','text')->model($mempelai)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('instagram','text')->model($mempelai)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('foto','text')->model($mempelai)->show() !!}
    ...
    ),$mempelai->exists?$mempelai->jenis_kelamin:'L') !!}
