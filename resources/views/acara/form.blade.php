...
<div class="modal-dialog modal-simple">
  {{ Form::model($acara,array('route' => array((!$acara->exists) ? 'acara.store':'acara.update',$acara->pk()),
  'class'=>'modal-content','id'=>'acara-form','method'=>(!$acara->exists) ? 'POST' : 'PUT')) }}
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">×</span>
    </button>
    <h4 class="modal-title" id="formModalLabel">{{ ($acara->exists?'Edit':'Tambah').' acaras' }}</h4>
  </div>
  <div class="modal-body">
    {!! App\Console\Commands\Generator\Form::input('id','hidden')->model($acara)->showHidden() !!}
    {!! App\Console\Commands\Generator\Form::input('waktu','text')->model($acara)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('tempat','text')->model($acara)->show() !!}
    {!! App\Console\Commands\Generator\Form::input('maps','text')->model($acara)->show() !!}
    {!! App\Console\Commands\Generator\Form::radio('jenis_acara','Jenis Acara',array(
    array('value'=>'1','label'=>'Akad'),
    array('value'=>'2','label'=>'Resepsi'),
    ),$acara->exists?$acara->jenis_acara:'1') !!}
